package com.example.feroz.materialdesign.fab.adapter;
...
public class FabGridAdapter extends BaseAdapter {
    ...
    public FabGridAdapter(Context context, ArrayList<ThemeObject> themeObjectArrayList) {
        mContext = context;
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            gridViewAndroid = inflater.inflate(R.layout.fab_gridview_item, null);
