package com.example.feroz.materialdesign.fab;
...
public class FabHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fab_home_fragment, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        programFab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                programFab1.setLabelColors(ContextCompat.getColor(getActivity(), R.color.mdb_elegant_dark_black),
                        ContextCompat.getColor(getActivity(), R.color.divider_gray),
                        ContextCompat.getColor(getActivity(), R.color.mdb_light_yellow));
                programFab1.setLabelTextColor(ContextCompat.getColor(getActivity(), R.color.mdb_elegant_dark_black));
            }
        });
